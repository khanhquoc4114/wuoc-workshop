...
![VPC](/images/3/3.1/s9.png)

Kiểm tra tài nguyên sau khi xóa
```aws dynamodb list-tables --profile badbob```

![VPC](/images/3/3.1/s9b.png)
...
![VPC](/images/3/3.1/s13b.png)
![VPC](/images/3/3.1/s13c.png)
